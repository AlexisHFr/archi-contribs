...
public class ArchimateDiagramLayoutConfigurationStore implements ILayoutConfigurationStore {
	...
	private final IDiagramModelComponent model;
	...
	private Properties getProperties() {
		return (Properties) model.getAdapter(Properties.class);
	}
	...
	public void setOptionValue(final String optionId, final String valueString) {
		...
		if (model != null) {
			...
			if (propAdapater == null) {
				...
				model.setAdapter(Properties.class, propAdapater);
			}
	...
	public Collection<String> getAffectedOptions() {
		if (model == null || getProperties() == null) {
	...
	public Set<Target> getOptionTargets() {
		...
		} else if (model instanceof IDiagramModelContainer) {
			if (((IDiagramModelContainer) model).getChildren().isEmpty()) {

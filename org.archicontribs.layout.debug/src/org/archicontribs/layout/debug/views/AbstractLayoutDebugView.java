...
import org.archicontribs.layout.debug.actions.ClearExecutionAction;
import org.archicontribs.layout.debug.actions.ClearExecutionsAction;
import org.archicontribs.layout.debug.actions.CollapseExecutionTreeAction;
import org.archicontribs.layout.debug.actions.CompressLogFolderAction;
import org.archicontribs.layout.debug.actions.ExpandExecutionTreeAction;
import org.archicontribs.layout.debug.actions.FilterExecutionTreeAction;
import org.archicontribs.layout.debug.actions.PreferenceAction;
import org.archicontribs.layout.debug.actions.RevealLogFolderAction;
import org.archicontribs.layout.debug.model.ExecutionInfo;
import org.archicontribs.layout.debug.model.ExecutionInfoContentProvider;
import org.archicontribs.layout.debug.model.IExecutionInfoModelListener;
...
public abstract class AbstractLayoutDebugView extends ViewPart implements IExecutionInfoModelListener {
    ...
    public void createPartControl(Composite parent) {
        ...
        LayoutDebugPlugin.getDefault().getModel().addExecutionInfoModelListener(this);
...
//        toolBarManager.add(collapseTreeAction);
    ...
    private void setupTreeViewer(Composite parent) {
        ...
        treeViewer.setInput(LayoutDebugPlugin.getDefault().getModel().getExecutionInfos());
    }
    ...
    private IDialogSettings retrieveDialogSettings() {
        return DialogSettings.getOrCreateSection(LayoutDebugPlugin.getDefault().getDialogSettings(), viewId);
    }

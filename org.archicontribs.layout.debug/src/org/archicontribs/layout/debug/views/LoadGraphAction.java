...
import org.archicontribs.layout.debug.views.graph.LayoutGraphView;
...
public class LoadGraphAction extends Action {
    ...
    public LoadGraphAction(final org.archicontribs.layout.debug.views.graph.LayoutGraphView layoutGraphView) {
        setId(ACTION_ID);
        setText("Load Graph");
        setToolTipText("Load, layout, and display a saved ELK graph.");
        setImageDescriptor(LayoutDebugPlugin.imageDescriptorFromPlugin(LayoutDebugPlugin.PLUGIN_ID, ICON_PATH));
    ...
    @Override
    public void run() {
        IPreferenceStore prefStore = LayoutDebugPlugin.getDefault().getPreferenceStore();
    ...
    public static void run(final String fullFilePath, final LayoutGraphView layoutGraphView) {
        ...
        if (fullFilePath != null) {
            ...
            try {
                ...
                LayoutDebugPlugin.getDefault().getModel().addExecution(info);

...
public class ImageExportAction extends Action {
                    ...
                    protected IStatus run(final IProgressMonitor monitor) {
                        try {
                            ...
                            if (monitor.isCanceled()) {
                                return new Status(IStatus.INFO, LayoutDebugPlugin.PLUGIN_ID, 0, "Aborted", null);
                            }
                            ...
                            return new Status(IStatus.INFO, LayoutDebugPlugin.PLUGIN_ID, 0, "OK", null);
                        } catch (SWTException exception) {
                            return new Status(IStatus.ERROR, LayoutDebugPlugin.PLUGIN_ID,
    ...
    private static String getFileName(final Display display) {
        IPreferenceStore preferenceStore = LayoutDebugPlugin.getDefault().getPreferenceStore();

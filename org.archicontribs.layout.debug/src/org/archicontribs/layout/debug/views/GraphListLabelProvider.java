...
public class GraphListLabelProvider extends LabelProvider {
    ...
    public GraphListLabelProvider() {
        ...
        elkImage = LayoutDebugPlugin.imageDescriptorFromPlugin(
                LayoutDebugPlugin.PLUGIN_ID, ELKGRAPH_IMAGE_PATH).createImage();
        jsonImage = LayoutDebugPlugin.imageDescriptorFromPlugin(
                LayoutDebugPlugin.PLUGIN_ID, JSON_IMAGE_PATH).createImage();
        dotImage = LayoutDebugPlugin.imageDescriptorFromPlugin(
                LayoutDebugPlugin.PLUGIN_ID, DOT_IMAGE_PATH).createImage();
    }
